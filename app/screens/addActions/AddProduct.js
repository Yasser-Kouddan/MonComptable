  ...
  try {
    ...
    if (user) {
      ...
      await addDoc(productsRef, {
        ...
        prodBuyPrice: product.prodBuyPrice,
        prodCategorie: product.prodCategorie,
        prodCriticalQuantity: product.prodCriticalQuantity,
        prodLabel: product.prodLabel,
        prodQuantity: product.prodQuantity,
        prodSellPrice: product.prodSellPrice,
      });
                      ...
                      <View style={mainStyles.card}>
                          ...
                          <View style={mainStyles.entryView}>
                              <ScrollView showsVerticalScrollIndicator={false}>
                                  <TextInput
                                      placeholder="étiquette ex:'Huile d'olive - 1L'"
